...
export const metadata = {
  title: "Términos y Condiciones | Lotería de Animales",
  description: "Leé los términos y condiciones de participación de la Lotería de Animales.",
}
...
export default async function TerminosPage() {
  ...
  try {
    ...
    html = pages.terminos_condiciones ?? null
  } catch {
    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        <PageHero
          ...
          title={<>Términos y{" "}<span className="text-primary">Condiciones</span></>}
          subtitle="Condiciones generales que rigen la participación en los sorteos."
        />
          ...
          {html ? (
            ...
            <div className="bg-card rounded-[2.5rem] p-12 md:p-16 text-center shadow-[0_8px_40px_rgba(0,0,0,0.3)]">
              ...
              <p className="text-muted-foreground max-w-sm mx-auto">
                Los términos y condiciones no están disponibles en este momento. Por favor, volvé a intentarlo más tarde.
              </p>
              <Link
                href="/"
