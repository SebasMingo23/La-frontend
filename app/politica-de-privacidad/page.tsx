...
export const metadata = {
  title: "Política de Privacidad | Lotería de Animales",
  description: "Conocé cómo tratamos y protegemos tus datos personales en la Lotería de Animales.",
}
...
export default async function PoliticaPrivacidadPage() {
  ...
  try {
    ...
    html = pages.politica_privacidad ?? null
  } catch {
    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        <PageHero
          ...
          title={<>Política de{" "}<span className="text-primary">Privacidad</span></>}
          subtitle="Tratamiento y protección de datos personales de nuestros usuarios."
        />
          ...
          {html ? (
            ...
            <div className="bg-card rounded-[2.5rem] p-12 md:p-16 text-center shadow-[0_8px_40px_rgba(0,0,0,0.3)]">
              ...
              <p className="text-muted-foreground max-w-sm mx-auto">
                La política de privacidad no está disponible en este momento. Por favor, volvé a intentarlo más tarde.
              </p>
              <Link
                href="/"
