  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background">
        <PageHero
          breadcrumb="Tabla de Premios"
          title={<>Tabla de{" "}<span className="text-primary">Premios</span></>}
          subtitle="Montos y categorías de premios vigentes para cada tipo de apuesta."
        />
